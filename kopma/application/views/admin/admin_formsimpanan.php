					...
					<header class="align-center">
						<h1>Tambah Anggota</h1>
								<!-- Form -->
									...
									<form method="post" action="<?php echo base_url().'admin/submit_simpanan' ?>">
											<!-- Break -->
											<div class="12u$">
												<div>
												...
												<input type="text" name="nama" id="nama" value="" placeholder="Nama" style="margin-top: 1.5em"/>
												<input type="text" name="email" id="email" value="" placeholder="Email" style="margin-top: 1.5em"/>
												<input type="date" name="deadline" id="deadline" value="" placeholder="Batas pembayaran" style="margin-top: 1em"/>
												<div class="row uniform">
                                            
											    <div class="4u 12u$(xsmall)">
												    <input type="text" name="jumlah" id="jumlah" value="" placeholder="Jumlah (ex:20000)" style="margin-top: 1em"/>
											    </div>
											     <div class="4u 12u$(xsmall)">
