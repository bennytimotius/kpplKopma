								...
								<!-- Table -->
									...
									<div class="table-wrapper">
										<table>
											...
											<form method="post" action="<?php echo base_url().'admin/delete_anggota'?>">
											<tbody>
										  <?php foreach ($list as $x) { ?>
										  <tr>
										  	<td><input type="checkbox" id="copy" name="anggota[]" value="<?php echo
											$x['id']?>"></td>
										   <td><?= $x['NAK'] ?></td>
										   <td><?= $x['name'] ?></td>
										   <td><?= $x['email'] ?></td>
										   <td><a href="<?php echo site_url("admin/viewProfile/".$x['username']); ?>" class="button alt small">Update</a></td>
										  </tr>
										  <?php } ?>
										 </tbody>
										</table>
										  <a href=<?php echo base_url("admin/register_anggota") ?> class="button special small">Tambah Anggota</a>
										  <input type="submit" value="Delete User" class="button special small">
									</div>
							</div>
			</section>
