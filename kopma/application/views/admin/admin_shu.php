								...
								<!-- Table -->
									...
									<div class="table-wrapper">
										<table>
											...
											<form method="post" action="<?php echo base_url().'admin/delete_shu'?>">
											<tbody>
												<?php foreach ($list as $x) { ?>
										  <tr>
										  	<td><input type="checkbox" name="shu[]" value="<?php echo
			$x['id']?>"></td>
										   <td><?= $x['nak'] ?></td>
										   <td><?= $x['nama'] ?></td>
										   <td><?= $x['sisa'] ?></td>
										   <td><?= $x['bulan'] ?></td>
										   <td><a href="<?php echo site_url("admin/viewSHU/".$x['name']); ?>" class="button alt small">Update</a></td>
										  </tr>
										  <?php } ?>

											</tbody>
										</table>
										  <a href=<?php echo base_url("admin/register_shu") ?> class="button special small">Update SHU</a>
										  <input type="submit" value="Delete SHU" class="button special small">
									</div>
                </div>
			</section>
