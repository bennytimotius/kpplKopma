				...
				<div class="inner">
					<header class="align-center">
						<h1>Sisa hasil Usaha</h1>
								<!-- Form -->
									<h3>Edit SHU</h3>
									<?php echo form_open_multipart('admin/updateSHU/' . $name); ?>
									<form method="post">
											<!-- Break -->
								        <div class="row uniform">								           
												...
												<div class="10u$ 12u$(small)">
												    <input type="text" name="bulan" id="Bulan" value="<?php echo $bulan ?>" placeholder="Bulan" />
												</div>
												<div class="2u 12u$(small) align-center">
												    <h2>NAK&nbsp;&nbsp;&nbsp;&nbsp;: </h2>
												</div>
												<div class="10u$ 12u$(small)">
												    <input type="text" name="nak" id="NAK" value="<?php echo $nak ?>" placeholder="Nomor Anggota Kopma" />
												</div>
												<div class="2u 12u$(small) align-center">
												    <h2>Nama&nbsp;&nbsp;&nbsp;&nbsp;: </h2>
												</div>
												<div class="10u$ 12u$(small)">
												    <input type="text" name="nama" id="nama" value="<?php echo $nama ?>" placeholder="Nama Anggota Kopma" />
												</div>
												<div class="2u 12u$(small) align-center">
												    <h2>SHU&nbsp;&nbsp;&nbsp;&nbsp;: </h2>
												</div>
												<div class="10u$ 12u$(small)">
												    <input type="text" name="sisa" id="SHU" value="<?php echo $sisa ?>" placeholder="Jumlah SHU" />
												</div>	
