					...
					<header class="align-center">
						<h1>Tambah Agenda</h1>
								<!-- Form -->
									...
									<form method="post" action="<?php echo base_url().'admin/submit_agenda' ?>">
											<!-- Break -->
											<div class="row uniform">								           
												...
												<div class="10u$ 12u$(small)">
												    <input type="date" name="tanggal" id="Tanggal" value="" placeholder="mm/dd/yyyy" />
												</div>
												<div class="2u 12u$(small) align-center">
												    <h2>Nama&nbsp;&nbsp;&nbsp;&nbsp;: </h2>
												</div>
												<div class="10u$ 12u$(small)">
												    <input type="text" name="nama" id="nama" value="" placeholder="Nama Agenda" />
												</div>
												<div class="2u 12u$(small) align-center">
												    <h2>Deskripsi&nbsp;&nbsp;&nbsp;: </h2>
												</div>
												<div class="10u$ 12u$(small)">
												    <input type="text" name="deskripsi" id="deskripsi" value="" placeholder="Deskripsi" />
												</div>	
                    							<div>
